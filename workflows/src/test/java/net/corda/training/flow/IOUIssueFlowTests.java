...
//
//        IOUIssueFlow.InitiatorFlow flow = new IOUIssueFlow.InitiatorFlow("GBP", 10, lender, borrower);
//
...
//        Party borrower = b.getInfo().getLegalIdentitiesAndCerts().get(0).getParty();
//
//        Future<SignedTransaction> futureOne = b.startFlow(new IOUIssueFlow.InitiatorFlow("GBP", 0, lender, borrower));
//        mockNetwork.runNetwork();
//
...
//        Future<SignedTransaction> futureTwo = b.startFlow(new IOUIssueFlow.InitiatorFlow("GBP", 0, lender, lender));
//        mockNetwork.runNetwork();
//        exception.expectCause(instanceOf(TransactionVerificationException.class));
//        futureTwo.get();
//
//        // Check a good IOU passes.
//        Future<SignedTransaction> futureThree = b.startFlow(new IOUIssueFlow.InitiatorFlow("GBP", 0, lender, borrower));
//        mockNetwork.runNetwork();
//        futureThree.get();
//    }
